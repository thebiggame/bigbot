...
var ErrMaxTeamsReached = errors.New(fmt.Sprintf("You are already a member of %d or more teams! Please contact an administrator if you need more", config.RuntimeConfig.MaxUserRoles))
